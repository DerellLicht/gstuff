...
static LRESULT CALLBACK WndProc (HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
   ...
   case WM_SIZE:
      ...
      xbase = cxClient / 2 ;        //  originally 320
      xdiff = (cxClient-50) / 2 ;   //  originally 320
      ybase = cyClient * 7 / 8 ;    //  originally 420
      ydiff = cyClient * 5 / 8 ;    //  originally 300
